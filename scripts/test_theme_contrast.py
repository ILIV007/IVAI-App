...
PAIRS = {
    "light": (
        ("JadePrimaryLight", "LightSurface"),
        ("IndigoSecondaryLight", "LightSurface"),
        ("CyanPrimaryLight", "LightSurface"),
        ("IvaiErrorLight", "LightSurface"),
        ("JadeOnContainerLight", "JadeContainerLight"),
        ("IndigoOnContainerLight", "IndigoContainerLight"),
    ...
    "dark": (
        ("JadePrimary", "IvaiBackground"),
        ("NeonViolet", "IvaiBackground"),
        ("CyanPrimary", "IvaiBackground"),
