...
| Build quality | debug/release minified، R8، Room/KSP، 155 test، lint صفر و guardهای Provider-neutral/RTL/contrast/Phase 8/R8/launcher پاس شده‌اند. | **Pass deterministic.** |
