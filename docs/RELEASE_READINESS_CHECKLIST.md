...
| Independent unit execution | Forced-rerun log and report totals | Zero failures, errors, and skipped tests. Current baseline is 143 tests and must not regress without a documented review. | Pending |
