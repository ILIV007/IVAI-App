...
| RTL and accessibility | Force-RTL, mixed BiDi, TalkBack/semantics, touch-target, contrast, and screenshot evidence. | IVAI wordmark semantic assertion and JVM screenshot coverage are implemented; global forced-LTR behavior, Force-RTL, TalkBack, touch-target and physical-device evidence remain pending. |
